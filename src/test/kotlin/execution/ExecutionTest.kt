...
//
//    @Test
//    fun `002 - Execution by ID should print expected output`() {
//        val snippetId = 1
//        val response = executionController.byId(snippetId)
//        Assertions.assertEquals("testing a simple print snippet", response.body)
//    }
//
//    @Test
//    fun `003 - Execution with empty snippet should return error`() {
//
//    }
}
